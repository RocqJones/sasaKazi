...
class ChatOnlineSafety : AppCompatActivity() {

    private val TAG = "ChatOnlineSafety"

    val MESSAGES_CHILD = "messages-onlinesafety"
    ...
    private var mBinding: ChatOnlineSafetyBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // use View Binding
        mBinding = ChatOnlineSafetyBinding.inflate(layoutInflater)
