...
class ChatGame : AppCompatActivity() {

    private val TAG = "ChatGame"

    val MESSAGES_CHILD = "messages-game"
    ...
    private var mBinding: ChatGameBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // use View Binding
        mBinding = ChatGameBinding.inflate(layoutInflater)
