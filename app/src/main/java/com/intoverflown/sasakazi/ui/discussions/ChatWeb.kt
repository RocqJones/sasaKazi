...
class ChatWeb : AppCompatActivity() {

    private val TAG = "ChatWeb"

    val MESSAGES_CHILD = "messages-web"
    ...
    private var mBinding: ChatWebBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // use View Binding
        mBinding = ChatWebBinding.inflate(layoutInflater)
