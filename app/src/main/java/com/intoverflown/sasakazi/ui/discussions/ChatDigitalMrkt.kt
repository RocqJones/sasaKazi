...
class ChatDigitalMrkt : AppCompatActivity() {

    private val TAG = "ChatDigitalMrkt"

    val MESSAGES_CHILD = "messages-digital-marketing"
    ...
    private var mBinding: ChatDigitalMrktBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // use View Binding
        mBinding = ChatDigitalMrktBinding.inflate(layoutInflater)
