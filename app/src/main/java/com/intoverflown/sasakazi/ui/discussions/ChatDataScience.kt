...
class ChatDataScience : AppCompatActivity() {
    private val TAG = "ChatDataScience"

    val MESSAGES_CHILD = "messages-data-science"
    ...
    private var mBinding: ChatDataScienceBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // use View Binding
        mBinding = ChatDataScienceBinding.inflate(layoutInflater)
